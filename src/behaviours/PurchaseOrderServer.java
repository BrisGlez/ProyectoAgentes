  ...
  public void action() {
    ...
    if(msg != null) {
      ...
      if(price != null) {
        ...
        gui.buyer(quien); //para que mande a buyer la cadena con el nombre del libro y el agente comprador
        System.out.println(quien); //impresión por consola para confirmar
      } else {
